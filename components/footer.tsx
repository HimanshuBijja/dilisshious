...
export default function Footer() {
  return (
    <footer className="bg-[#2d2016] text-white">
      {/* Social Media Links */}
      <div className="flex justify-center gap-4 pt-12 pb-8">
        <a
          href="https://instagram.com"
          target="_blank"
          rel="noopener noreferrer"
          className="w-11 h-11 rounded-full border-2 border-[#c8956c] flex items-center justify-center hover:bg-[#c8956c] transition-all duration-300 hover:scale-110"
